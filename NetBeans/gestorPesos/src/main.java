        ...
        do {
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    pesoOptimoSup = (ultimoPeso * 24.9 ) / IMC;
                    double pesoOptimoInf = 0;
                    pesoOptimoInf = (ultimoPeso  * 18.5 ) /IMC;
                    System.out.println("\tSu peso óptimo oscila entre: " + pesoOptimoInf + " y " + pesoOptimoSup);
                    double kgEngordar = 0;
                    double kgAdelgazar = 0;
                    kgEngordar = pesoOptimoInf - ultimoPeso;
                    kgAdelgazar = ultimoPeso - pesoOptimoSup;
